...
{
    internal class TalonpilePickingCardsValidatorTheoryData : CardsValidatorTheoryDataBase<IPickingCardsValidator>
    {
        public TalonpilePickingCardsValidatorTheoryData() 
            : base(new TalonpilePickingCardsValidator())
        {
        }
