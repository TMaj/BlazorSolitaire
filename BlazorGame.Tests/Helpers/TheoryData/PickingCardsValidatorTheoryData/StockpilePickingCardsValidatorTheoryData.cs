...
{
    internal class StockpilePickingCardsValidatorTheoryData : CardsValidatorTheoryDataBase<IPickingCardsValidator>
    {
        public StockpilePickingCardsValidatorTheoryData()
            : base(new StockpilePickingCardsValidator())
        {
        }
        ...
        protected override IList<List<object>> GetTheoryData()
        {
            ...
            {
                new List<object> { cards, cards[3], false },
